...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'f16cdbdd-f376-11ee-a663-7a6d203aa2cf:1-53';
...
INSERT INTO `BRANCH` VALUES ('BRAN000001','New York City','New York',1234567890),('BRAN000002','Los Angeles','California',2345678901),('BRAN000003','Chicago','Illinois',3456789012),('BRAN000004','Houston','Texas',4567890123),('BRAN000005','Miami','Florida',5678901234),('BRAN000006','Seattle','Washington',6789012345),('BRAN000007','San Francisco','California',7890123456),('BRAN000008','Boston','Massachusetts',8901234567),('BRAN000009','Atlanta','Georgia',9012345678),('BRAN000010','Denver','Colorado',1234567890);
...
INSERT INTO `CUSTOMER` VALUES ('LIC0011223',3334445555,'oliver.robinson@example.com','Oliver','Robinson'),('LIC0022334',4445556666,'sophia.nguyen@example.com','Sophia','Nguyen'),('LIC0123456',2223334444,'sophia.taylor@example.com','Sophia','Taylor'),('LIC1122334',4445556666,'daniel.anderson@example.com','Daniel','Anderson'),('LIC1234567',1234567890,'john.doe@example.com','John','Doe'),('LIC2345678',8876543210,'jane.smith@example.com','Jane','Smith'),('LIC3344556',6667778888,'matthew.jackson@example.com','Matthew','Jackson'),('LIC3456789',5551234567,'michael.jackson@example.com','Michael','Jackson'),('LIC4455667',5556667777,'isabella.thomas@example.com','Isabella','Thomas'),('LIC4567890',9998887776,'maria.garcia@example.com','Maria','Garcia'),('LIC5566778',7778889999,'emily.white@example.com','Emily','White'),('LIC5678901',1235556789,'james.brown@example.com','James','Brown'),('LIC6677889',8889990000,'jacob.martinez@example.com','Jacob','Martinez'),('LIC6789012',7779998888,'emma.johnson@example.com','Emma','Johnson'),('LIC7788990',9990001111,'ava.thompson@example.com','Ava','Thompson'),('LIC7890123',8884445555,'william.wilson@example.com','William','Wilson'),('LIC8899001',1112223333,'mason.garcia@example.com','Mason','Garcia'),('LIC8901234',6667778888,'olivia.miller@example.com','Olivia','Miller'),('LIC9012345',3332221111,'alexander.moore@example.com','Alexander','Moore'),('LIC9900112',2223334444,'abigail.hernandez@example.com','Abigail','Hernandez');
...
-- Dump completed on 2024-04-05 14:38:26
