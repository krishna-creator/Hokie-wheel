...
document
  ...
  .addEventListener("click", function (e) {
    ...
    var reservation_date = document.querySelector(
    ...
    $.post(
      ...
      function (data) {
        ...
        tr.append($("<th></th>").text("Customer License"));
        ...
        for (let i = 0; i < data.reservation.length; i++) {
          ...
          reserved_date =
            reserved_date.getFullYear() +
            "-" +
            (reserved_date.getMonth() + 1) +
            "-" +
            reserved_date.getDate();
          pickup_date =
            pickup_date.getFullYear() +
            "-" +
          ...
          if (data.reservation[i].plate_id == null)
            tr.append($("<td></td>").text("No Results Found"));
          else tr.append($("<td></td>").text(data.reservation[i].plate_id));
          if (data.reservation[i].make == null)
            tr.append($("<td></td>").text("No Results Found"));
          else tr.append($("<td></td>").text(data.reservation[i].make));
          if (data.reservation[i].model == null)
            tr.append($("<td></td>").text("No Results Found"));
          else tr.append($("<td></td>").text(data.reservation[i].model));
          if (data.reservation[i].year == null)
            tr.append($("<td></td>").text("No Results Found"));
          else tr.append($("<td></td>").text(data.reservation[i].year));
          if (data.reservation[i].price == null)
            tr.append($("<td></td>").text("No Results Found"));
          else tr.append($("<td></td>").text(data.reservation[i].price));
          if (data.reservation[i].reserve_date == null)
            tr.append($("<td></td>").text("No Results Found"));
          else tr.append($("<td></td>").text(reserved_date));
          if (data.reservation[i].pickup_date == null)
            tr.append($("<td></td>").text("No Results Found"));
          else tr.append($("<td></td>").text(pickup_date));
          if (data.reservation[i].return_date == null)
            tr.append($("<td></td>").text("No Results Found"));
          else tr.append($("<td></td>").text(return_date));
          if (data.reservation[i].payment_date == null)
            tr.append($("<td></td>").text("Not Paid Yet"));
          else tr.append($("<td></td>").text(payment_date));
          if (data.reservation[i].ssn == null)
            tr.append($("<td></td>").text("No Results Found"));
          else tr.append($("<td></td>").text(data.reservation[i].ssn));
          if (data.reservation[i].fname == null)
            tr.append($("<td></td>").text("No Results Found"));
          else tr.append($("<td></td>").text(data.reservation[i].fname));
          if (data.reservation[i].lname == null)
            tr.append($("<td></td>").text("No Results Found"));
          else tr.append($("<td></td>").text(data.reservation[i].lname));
          if (data.reservation[i].email == null)
            tr.append($("<td></td>").text("No Results Found"));
          else tr.append($("<td></td>").text(data.reservation[i].email));
          if (data.reservation[i].phone_no == null)
            tr.append($("<td></td>").text("No Results Found"));
          else tr.append($("<td></td>").text(data.reservation[i].phone_no));
